...
if __name__ == '__main__':
    ...
    scan = attenuation()
    scan.attenuation_Energy(PdfPages=PdfPages, Directory=Directory, targets =targets[0:3],x_offset=x_offset[0:3],y_offset=y_offset[0:3],n = n[0:3],color=color)
    #scan.attenuation_thickness(PdfPages=PdfPages, Directory=Directory, targets =["Al"], logx = True, logy= True,color=color)
    #scan.mass_attenuation_coeff(PdfPages=PdfPages, Directory=Directory, targets =["Si"])
    scan.close()
