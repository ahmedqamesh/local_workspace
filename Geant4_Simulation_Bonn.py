...
class Simulation():
    ...
    def Rd53_metal_layers(self,location=False,Directory=False,ax2=False):
        total_metal = []
        thickness_nano = []
    ...
    def get_attenuation(self,Directory=False, PdfPages=False,location=False, title=False,colors=colors):
        fig = plt.figure()
        ax2 = plt.subplot(111)
...
# RD53 Simulation    
    Attenuation = scan.get_attenuation(Directory=Directory, PdfPages=PdfPages, location="RD53", title="Attenuation of photons through metal layer stack",colors=colors)
    
    Energy_deposition = scan.Energy_deposition(Directory=Directory, PdfPages=PdfPages,test=["RD53","RD53","RD53","RD53"],logy=True, hist_id=["9","7", "8","2"],xmin=0.0, xmax=60, location="RD53", colors=colors,
...
#     Geant4_RD53 = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=spectrum, hist_id=["28", "32", "23", "32"], labels=["Tungsten-Spectrum", "Be-0.3mm-Spectrum", "Al-0.15mm-Spectrum","RD53 Last Layer"],
...
#                                      title="Tungsten x-ray spectrum in the back of the last metal layer stack of RD53")
    ...
    RD53 = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=RD53_layers, hist_id=["32", "32"], outputname="RD53_Spectrum", 
...
#     tracklength = scan.Metal_layers(Directory=Directory, PdfPages=PdfPages, test=["RD53"], hist_id=["39"], location="RD53", logx=False, logy=True, style="-", colors=colors,xmin=0.0, xmax=800,
#                                         title="Track length of charged secondaries",outputname="Secondary_electrons_depth", xtitle="Track Length [$\mu m $]")
# 
#     Vertex = scan.Metal_layers(Directory=Directory, PdfPages=PdfPages, test=["RD53"], hist_id=["40"], location="RD53", colors=colors, style="--",
#                                                title="x-vertex of charged secondaries in RD53",outputname="Vertex",xtitle="Vertex position [$\mu m $]")
#     
#     Secondary_electrons = scan.get_Secondary_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53"], table=True,
...
# Extra tests
    Sio2 = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53-sio2"], hist_id=["9"], outputname="RD53-SiO2", Ratio=False, colors=['black', '#7e0044'],style="-",
                             logx=False, logy=True, location="RD53", title="Energy deposition in all the silicon layers [$4.5 \mu m$] of RD53 Metal Stack")
    
    Geant4_RD53_siO2 = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53-sio2","RD53-sio2"], hist_id=["23", "32"],
...
# Diode spectra
    Sio2_diode = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53-sio2-0.05"], hist_id=["9"], outputname="RD53-SiO2-0.05", Ratio=False, colors=['black', '#7e0044'],style="-",
                             logx=False, logy=True, location="RD53", title="Energy deposition in all the silicon layers [$50 \mu m$] of RD53 Metal Stack")
    
    Geant4_RD53_siO2_diode = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53-sio2-0.05","RD53-sio2-0.05"], hist_id=["23", "32"],
    ...
    G4_Cu = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53-G4-Cu"], hist_id=["8"], outputname="RD53-G4-Cu", Ratio=False, colors=['black', '#7e0044'],style="-",
                             logx=False, logy=True, location="RD53", title="Energy deposition in all the Copper layers [$5.8 \mu m$] of RD53 Metal Stack")
    
    Geant4_RD53_Cu = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53-G4-Cu","RD53-G4-Cu"], hist_id=["23", "32"],
                                    logy=True, Ratio=False, colors=colors, location="RD53", outputname="spectrum_Cu",
                                     title="Tungsten x-ray spectrum after [$5.8 \mu m$] $Cu$")


#     Secondary_electrons = scan.get_Secondary_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53"], table=True,xmin=0.0, xmax=60,style="-",
#                                                       hist_id=["51", "52", "53", "54"], location="RD53", logy=True, logx=False, colors=colors,
#                                                       outputname="Secondary_electrons", title=["with metal layers"])
#     Radius = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53"], hist_id=["48"], outputname="radius", Ratio=False, colors=['black', '#7e0044'],style="-",xmin=0.0, xmax=0.02,
#                              logx=False, logy=False, location="RD53", title="Radius of secondary charged tracks at the last layer of RD53", xtitle="Radius[mm]")
#     
#     projection = scan.get_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53"], hist_id=["47"], outputname="radius", Ratio=False, colors=['black', '#7e0044'],style="-",
