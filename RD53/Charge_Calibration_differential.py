...
Directory = "/home/silab62/git/XrayMachine_Bonn/Charge_Calibration/differential/"
global PdfPages
PdfPages = PdfPages(Directory + 'Charge_calibration_differential.pdf')
...
interpreted_file = [r"/media/silab62/e799a8d8-915c-4baf-9300-6ce63932dbc2/home/silab/RD53/interpreted_files_diff/20181204_193541_hitor_calibration_interpreted.h5"]

data_files = [r"/media/silab62/e799a8d8-915c-4baf-9300-6ce63932dbc2/home/silab/RD53/interpreted_files_diff/20181129_172049_source_scan_interpreted.h5",  # Cu
              r"/media/silab62/e799a8d8-915c-4baf-9300-6ce63932dbc2/home/silab/RD53/interpreted_files_diff/20181126_160758_source_scan_interpreted.h5",  # Mo
              r"/media/silab62/e799a8d8-915c-4baf-9300-6ce63932dbc2/home/silab/RD53/interpreted_files_diff/20181127_142404_source_scan_interpreted.h5"]  # Nb
# Fit parameters are a1, a2, m1, m2, sd1, sd2
calibrated_fit_parameters = [(25000, 220, 5),
                             (165000, 100000, 480, 556, 10, 5),  # Mo
                             (165000, 100000, 450, 515, 10, 5)]
calibrated_fit_ranges = [(130, 250),
                         (439, 570),
                         (418, 560)]
titles = ["Cu", "Mo", "Nb"]
peaks = []
...
sigmas = []
sigmas_error = []
selected_columns = range(264, 400)
...
#     w = 3.65
#     charge = x_sel / w * 1000
#     charge_err = peaks_error_sel / w *  1000
