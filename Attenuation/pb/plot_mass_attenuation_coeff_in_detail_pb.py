...
data = loadtxt('plot_mass_attenuation_coeff_in_detail_pb.dat')
x = data[:, 0]
...
ax.set_yscale('log')
plt.tight_layout()
plt.title(r'Mass atenuation coeffecient in pb', fontsize=11)
plt.savefig(r'mass_attenuation_coeff_pb_in_detail_1_100keV_pb_with_coherentscattering.pdf', bbox_inches='tight')
plt.show()
