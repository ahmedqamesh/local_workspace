...
data = loadtxt('mass_attenuation_coeff_in_detail_1_100keVBe.dat')
...
ax = plt.gca()
#plt.xlim(1, 10**2)
#plt.ylim(0.0001, 10**4)
plt.xlabel('Photon energy / keV')
plt.ylabel('Mass attenuation coefficient / cm$^2$/g')
plt.legend(handles=[y_plot, p_plot, i_plot, r_plot, ppn_plot, ppe_plot])
...
ax.set_yscale('log')
#plt.show()
plt.title(r'Mass atenuation coeffecient in Be', fontsize=11)
plt.tight_layout()
plt.savefig(r'mass_attenuation_coeff_in_detail_Be.pdf', bbox_inches='tight')